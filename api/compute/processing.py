...
from .. import common
from constants import VDJ_10X_CHOSEN_COLUMNS
...
def reformat_clonotypes(vdj_path, preprocessing=True):
	chosen_columns = [i.value for i in VDJ_10X_CHOSEN_COLUMNS]
...
def merge_with_clinical_meta(vdj_df, meta_df):
	print ('WARNING: only keep intersect barcodes')
	vdj_original_bc = vdj_df[VDJ_10X_CHOSEN_COLUMNS.BARCODES.value].values
